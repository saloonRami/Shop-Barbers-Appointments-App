...
SVC_NAME="actions.runner.RamiAlaidyIOS-Shop-Barbers-Appointments-App.Barber-Two"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (RamiAlaidyIOS-Shop-Barbers-Appointments-App.Barber-Two)"
